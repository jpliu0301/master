...
public class DataBaseInput implements IEditorInput {
	...
	public DataBaseInput(CTableTreeNode node, String name, CBasicTreeViewer treeView) {
		this.node = node;
		this.name = name;
		this.treeView = treeView;
	}
	public DataBaseInput(CTableTreeNode node, String name,String type, CBasicTreeViewer treeView) {
		this.node = node;
		this.name = name;
		this.type = type;
		this.treeView = treeView;
