...
public class DeployTargetNode extends ActivityTargetNode {
	...
	public DeployTargetNode(DataBaseInput input, CNodeEntity node, boolean isPool,boolean isMain) {
		super(UUID.randomUUID().toString(), "目标点");
		this.input = input;
		this.node = node;
		this.isPool = isPool;
		this.isMain = isMain;
